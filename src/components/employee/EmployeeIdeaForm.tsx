  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await setDoc(doc(db, "ideas", ideaId), {
        ...
        aiScore: Math.floor(Math.random() * 81) + 20,
        roiScore: Math.floor(Math.random() * 81) + 20,
        feasibilityScore: Math.floor(Math.random() * 81) + 20,
        strategicFitScore: Math.floor(Math.random() * 81) + 20,
